/**
 * @description SVG浠绘剰鍥惧舰鍜宲ath璺緞鐨勯潰绉绠楁柟娉�
  ...
  function convertPathData(node) {
    ...
    switch (tagName) {
      ...
      case 'rect':
        ...
        /*
         * rx 鍜� ry 鐨勮鍒欐槸锛�
         * 1. 濡傛灉鍏朵腑涓€涓缃负 0 鍒欏渾瑙掍笉鐢熸晥
         * 2. 濡傛灉鏈変竴涓病鏈夎缃垯鍙栧€间负鍙︿竴涓�
         * 3.rx 鐨勬渶澶у€间负 width 鐨勪竴鍗�, ry 鐨勬渶澶у€间负 height 鐨勪竴鍗�
         */
        ...
        // 闈炴暟鍊煎崟浣嶈绠楋紝濡傚綋瀹藉害鍍�100%鍒欑Щ闄�
        // if (isNaN(x - y + width - height + rx - ry)) return;

        rx = rx > width / 2 ? width / 2 : rx
        ry = ry > height / 2 ? height / 2 : ry

        // 濡傛灉鍏朵腑涓€涓缃负 0 鍒欏渾瑙掍笉鐢熸晥
        if (rx == 0 || ry == 0) {
          // var path =
          //     'M' + x + ' ' + y +
          //     'H' + (x + width) +
      ...
      case 'polygon':
      case 'polyline': // ploygon涓巔olyline鏄竴鏍风殑,polygon澶氳竟褰紝polyline鎶樼嚎
